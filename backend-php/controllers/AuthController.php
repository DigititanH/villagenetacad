...
class AuthController
{
    ...
    /**
     * Mobile app sends body client=mobile and/or header X-VNA-Client: mobile.
     * Shared backend + .env with website — app@ welcome mail is mobile-only.
     *
     * @param array<string,mixed> $body
     */
    private static function isMobileClient(array $body): bool
    {
