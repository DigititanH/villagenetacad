  ...
  return (
    <div className="section-padding">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-black mb-8 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">My Wishlist</h1>
        {!items.length ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {items.map((item) => (
              <div key={item.id} className="group bg-white/5 border border-white/10 backdrop-blur-2xl rounded-[2rem] overflow-hidden hover:border-cyan-400/40 transition-all duration-700 hover:-translate-y-3">
                <Link to={`/shop/${item.slug}`} className="aspect-square bg-white/5 block overflow-hidden">
                ...
                <div className="p-5">
                  ...
                  <p className="font-black text-cyan-400 text-xl mb-3">R{Number(item.price).toFixed(2)}</p>
