    ...
    <div>
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-cyan-400 uppercase tracking-[0.4em] text-xs font-semibold mb-4">{digititanHero.label}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {digititanStats.map((s, i) => (
              <div key={i} className="card text-center hover:-translate-y-3 hover:shadow-[0_0_40px_rgba(0,255,255,0.1)]">
                <p className="text-4xl font-black bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent mb-1">{s.value}</p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 leading-8 mt-6">
                <strong className="text-cyan-400">Village NetAcad Academy</strong> is Digititan&apos;s initiative introducing {digititanAbout.villageNetAcad}
              </p>
            </div>
            <div className="card p-10">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 mt-6 text-cyan-400 text-sm font-semibold hover:underline"
              >
      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-black text-center mb-4 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">What We Do</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {digititanPillars.map((item, i) => {
              ...
              return (
                <div key={i} className="card flex gap-5 hover:border-cyan-400/40 hover:-translate-y-2 transition-all duration-500">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-500 to-purple-600 flex items-center justify-center flex-shrink-0">
      ...
      <section className="section-padding">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="card p-10 border-purple-500/30">
            <h2 className="text-2xl font-black mb-4 text-purple-400">{digititanRegistration.asc.title}</h2>
      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <a href={`mailto:${digititanLinks.email}`} className="card flex items-start gap-4 hover:-translate-y-2 hover:border-cyan-400/40 transition-all">
            ...
            <a href={digititanLinks.website} target="_blank" rel="noopener noreferrer" className="card flex items-start gap-4 hover:-translate-y-2 hover:border-cyan-400/40 transition-all">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-purple-600 flex items-center justify-center flex-shrink-0">
                <Phone size={20} className="text-white" />
              </div>
              <div>
                <h3 className="font-bold text-cyan-400 mb-1">Website</h3>
                <p className="text-sm text-gray-400">digititan.co.za</p>
              </div>
            </a>
            <a href={digititanLinks.maps} target="_blank" rel="noopener noreferrer" className="card flex items-start gap-4 hover:-translate-y-2 hover:border-cyan-400/40 transition-all">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-purple-600 flex items-center justify-center flex-shrink-0">
                <MapPin size={20} className="text-white" />
              </div>
              <div>
                <h3 className="font-bold text-cyan-400 mb-1">Location</h3>
      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link to="/contact" className="inline-block mt-4 text-cyan-400 font-semibold hover:underline">
