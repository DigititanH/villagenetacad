...
/// Village NetAcad mark + Powered by DIGITITAN for branded screens.
class DigititanBrandHeader extends StatelessWidget {
  final bool compact;

  /// Meeting feedback: login hero logo should read larger.
  final bool hero;
  ...
  Widget build(BuildContext context) {
    final logoSize = compact ? 72.0 : (hero ? 248.0 : 200.0);
    return Column(
