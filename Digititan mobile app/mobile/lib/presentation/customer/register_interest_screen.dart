...
class _RegisterInterestScreenState extends State<RegisterInterestScreen> {
  ...
  static const _genders = ['Female', 'Male', 'Prefer not to say', 'Other'];
      ...
      case Success():
        ...
        await showDialog<void>(
          ...
          builder: (_) => AlertDialog(
            ...
            content: Text(
              'Thanks. We stored your learner details (name, gender, email) '
              'for LMS alignment on "${widget.training.title}".',
            ),
            actions: [
              TextButton(
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            Text(
              'Learner details are stored for LMS alignment.',
