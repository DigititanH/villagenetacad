      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Payment (meeting decision):\n'
              '• Same gateway as Digititan Store: ${AppConfig.paymentGatewayName}\n'
              '• Payment happens in the app\n'
              '• Then confirm with OTP ${AppConfig.paymentOtpDemo}\n'
