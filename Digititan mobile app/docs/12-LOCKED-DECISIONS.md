...
## Reseller model
- Codes: **VNA-B-*** (beneficiary / independent) vs **VNA-C-*** (centre) — meeting agreed; issued at register
- Independent (no centre): **53%** seller · rest Digititan
- Affiliated with centre: **53%** seller · **26%** centre · **21%** Digititan (centre name stored; multi-party ledger polish later)
