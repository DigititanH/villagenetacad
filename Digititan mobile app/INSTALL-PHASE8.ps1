...
Write-Host ""
Write-Host "Backend deploy (when ready): live tree is public_html/backend-php/"
Write-Host "  - overwrite controllers/ResellersController.php"
Write-Host "  - do NOT overwrite routes/Router.php wholesale (CCNA etc on live)"
Write-Host "  - only ADD: GET /api/resellers/verify/{code} in the Resellers section"
Write-Host ""
