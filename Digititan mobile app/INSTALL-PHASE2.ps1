...
Write-Host ""
Write-Host "Ops Admin (ops@demo.com / demo123):"
Write-Host "  Ambassadors tab -> Approve Sipho (under review) + see all + Deactivate/Unlock"
Write-Host "  Resellers tab -> pending approve + All resellers Deactivate/Unlock"
Write-Host "  After deactivate: reseller@demo.com or lerato.ambassador@example.com cannot login"
Write-Host ""
