# PHASE 4B - Shared accounts install (ASCII only, v2)
...
Write-Host ""
Write-Host "SUCCESS - Phase 4 lib is on this machine. (install v2)" -ForegroundColor Green
Write-Host ""
...
Write-Host "  2) Start backend on port 5000 in Terminal A."
Write-Host ""
Write-Host "Default: dummy auth (decks) - flutter run with NO API_BASE_URL."
Write-Host "Live API (Android emulator to host):"
Write-Host "  cd mobile"
Write-Host "  flutter pub get"
Write-Host "  flutter run --dart-define=API_BASE_URL=http://10.0.2.2:5000"
Write-Host ""
Write-Host "If build mentions android-37: flutter_secure_storage is pinned to 9.2.4 (SDK 36 OK)."
